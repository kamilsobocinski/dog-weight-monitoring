...
export const breeds = [
  ...
  { id: 3,  name: "Golden Retriever",           male: { min: 29, max: 34 }, female: { min: 25, max: 32 }, growth: [0.25,0.55,0.80,0.90,0.97,1.00] },
  ...
  { id: 7,  name: "Poodle (Miniature)",         male: { min: 4.5, max: 7 }, female: { min: 4.5, max: 7 }, growth: [0.38,0.65,0.84,0.94,0.99,1.00] },
  ...
  { id: 12, name: "Boxer",                      male: { min: 29, max: 36 }, female: { min: 25, max: 29 }, growth: [0.28,0.52,0.72,0.86,0.97,1.00] },
  ...
  { id: 18, name: "Australian Shepherd",        male: { min: 23, max: 29 }, female: { min: 16, max: 25 }, growth: [0.30,0.55,0.75,0.88,0.97,1.00] },
  ...
  { id: 28, name: "Maltese",                    male: { min: 3, max: 4 }, female: { min: 3, max: 4 }, growth: [0.42,0.70,0.88,0.96,1.00,1.00] },
  ...
  { id: 37, name: "Bichon Frise",               male: { min: 4.5, max: 8 }, female: { min: 4, max: 7.5 }, growth: [0.42,0.70,0.88,0.96,1.00,1.00] },
  ...
  { id: 40, name: "Papillon",                   male: { min: 1.5, max: 4.5 }, female: { min: 1.5, max: 5 }, growth: [0.42,0.70,0.88,0.96,1.00,1.00] },
  { id: 41, name: "Saint Bernard",              male: { min: 64, max: 82 }, female: { min: 54, max: 64 }, growth: [0.20,0.42,0.62,0.77,0.93,1.00] },
  { id: 42, name: "Akita",                      male: { min: 45, max: 60 }, female: { min: 32, max: 45 }, growth: [0.27,0.50,0.70,0.84,0.96,1.00] },
  ...
  { id: 50, name: "Dalmatian",                  male: { min: 27, max: 32 }, female: { min: 24, max: 29 }, growth: [0.30,0.55,0.75,0.88,0.97,1.00] },
  ...
  { id: 69, name: "Schipperke",                 male: { min: 4,  max: 7  }, female: { min: 4,  max: 7  }, growth: [0.40,0.68,0.86,0.95,1.00,1.00] },
  ...
  { id: 78, name: "Whippet",                    male: { min: 12, max: 18 }, female: { min: 10, max: 15 }, growth: [0.33,0.60,0.80,0.92,0.99,1.00] },
  ...
  { id: 91, name: "Finnish Spitz",              male: { min: 12, max: 13 }, female: { min: 7,  max: 10 }, growth: [0.35,0.62,0.82,0.93,0.99,1.00] },
  ...
  { id: 94, name: "Kuvasz",                     male: { min: 48, max: 62 }, female: { min: 37, max: 50 }, growth: [0.25,0.48,0.68,0.82,0.95,1.00] },
